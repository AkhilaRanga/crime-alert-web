...
public class PasswordUtils {
    ...
    public EncodedPassword generateUserPassword(String userPassword)
    {
    	String salt = getSalt(30);
        
        // Protect user's password. The generated value can be stored in DB.
        String genaratedPassword = generateSecurePassword(userPassword, salt);
        
        EncodedPassword encodedPassword = new EncodedPassword();
        encodedPassword.setEncodedPassword(genaratedPassword);
        encodedPassword.setSalt(salt);
